...
public class Client : MonoBehaviour
{
        ...
        while (recData != NetworkEventType.Nothing)
        {
            switch (recData)
            {
                ...
                case NetworkEventType.ConnectEvent:
                    string name = Encoding.Unicode.GetString(recBuffer, 0, dataSize);
                    onMessageReceive?.Invoke(name);
    ...
    public new void SendMessage(string message)
    {
        ...
        NetworkTransport.Send(hostID, connectionID, reliableChannel, buffer,
         message.Length * sizeof(char), out error);
    ...
    public void SendUserName(string name)//!!!!
    {
        ...
        NetworkTransport.Send(hostID, connectionID, reliableChannel, nameBuffer,
         name.Length * sizeof(char), out error);
